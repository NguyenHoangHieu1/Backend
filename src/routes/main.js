...
mainRoute.get("/orders/:userId", is_Auth_1.default, main_1.getOrders);
mainRoute.post("/add-order", is_Auth_1.default, main_1.postAddOrder);
mainRoute.post("/contact", main_1.postContact);
